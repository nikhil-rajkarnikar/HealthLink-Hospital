 ...
 * @author pukarsharma
 */
public class CheckEmployeeDetailController extends BaseController {
    ...
    TableColumn<Employee, String> isAdminColumn = new TableColumn<>("Is Administrator");
    ...
    private void setupTableView() {
        ...
        ObservableList<Employee> employeeData = FXCollections.observableArrayList(databaseModel.getAllEmployees());
