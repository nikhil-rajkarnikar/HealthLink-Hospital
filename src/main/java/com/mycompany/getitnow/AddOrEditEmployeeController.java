 ...
 * @author pukarsharma
 */
public class AddOrEditEmployeeController extends BaseController {
    ...
    private void handleSaveEmployeeButton() {
        ...
        if (employee == null) {
            ...
            Employee emp = new Employee(0, name, email, password, true, address, phone);
            ...
            if (databaseModel.insertEmployee(name, email, password, isManager, address, phone)) {
                ...
                Employee recentlyCreatedEmployee = databaseModel.getEmployeeDetails(email);
    ...
    private void insertDefaultAccount(Employee newEmployee) {
